    ...
    public static void main(String[] args) {
        ...
        while (true) {// бесконечный цикл
            ...
            if (command == 1) {//Команда - Ввести количество шагов за определённый день;
                ...
                stepTrackerUser.printStepsMounth(keyMonth);
                stepTrackerUser.sumStepsMounth(keyMonth);
                stepTrackerUser.averStepsMount(keyMonth);
                stepTrackerUser.calculateDistanceInKm(keyMonth);
                stepTrackerUser.calculateFireCalories(keyMonth);
                stepTrackerUser.bestSeries(keyMonth);
                System.out.println();
